                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form novalidate method="POST" action="{{ url('/customer/store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="customer_account_number" name="customer_account_number">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="previous_sap_customer_number" name="previous_sap_customernumber">
                                            ...
                                            <div class="tab-pane fade" id="reference" role="tabpanel" aria-labelledby="reference-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="customer_name" class="form-label">Customer No. Reference</label>

                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ url('/customer/store') }}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="local_customer" value="local_customer" required>
                                                                    <label class="form-check-label" for="local_customer">MKM Local customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="trade_customer" value="trade_customer">
                                                                    <label class="form-check-label" for="trade_customer">MKM Trade customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="overseas_customer" value="overseas_customer">
                                                                    <label class="form-check-label" for="overseas_customer">MKM Overseas customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="non_trade_customer" value="non_trade_customer">
                                                                    <label class="form-check-label" for="non_trade_customer">MKM Non Trade customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="general_affairs_customer" value="general_affairs_customer">
                                                                    <label class="form-check-label" for="general_affairs_customer">MKM General Affairs customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="others_individual_customer" value="others_individual_customer">
                                                                    <label class="form-check-label" for="others_individual_customer">MKM Others / Individual customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="employee_customer" value="employee_customer">
                                                                    <label class="form-check-label" for="employee_customer">MKM Employee customer</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="account_group" id="government_related_customer" value="government_related_customer">
                                                                    <label class="form-check-label" for="government_related_customer">Government Related customer</label>
                                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="previous_sap_customer_number" name="previous_sap_customer_number">
                                                        </div>
                                        ...
                                        <h3><strong> Reference (only use for copy customer with the same description)</strong></h1>
                                        ...
                                        <h3><strong>Create Customer Address</strong></h3>
                                        ...
                                        <h3><strong>Create Customer Control</strong></h3>
                                        ...
                                        <h3><strong>Create Customer Payment Control</strong></h3>
                                        ...
                                        <h3><strong>Create Customer Accounting Information </strong></h3>
                                        ...
                                        <h3><strong>Create Customer Payment Transaction</strong></h3>

                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title m-0">Customer Master Form</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Modal form -->
                <form action="{{url('customer/approval')}}" method="POST">
                    @csrf
                    <div class="mb-3">
            ...
            if (this.checked) {
                remandToContainer.style.display = 'none';
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- Display Customer Master Details -->
                                    <h2>{{ $data->customer_name }}</h2>
                                    <p>Customer Account Number: {{ $data->customer_account_number }}</p>
